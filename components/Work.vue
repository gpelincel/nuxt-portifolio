<template>
    <div class="grid grid-cols-3 gap-4">
        <div class="flex flex-col items-center justify-center text-center">
            <img class="invert w-1/3" src="~/assets/img/coding.png" alt="">
            <h1 class="uppercase text-2xl font-semibold">Experiência Profissional</h1>
        </div>
        <div class="space-y-2 border-r border-white text-justify pr-4">
